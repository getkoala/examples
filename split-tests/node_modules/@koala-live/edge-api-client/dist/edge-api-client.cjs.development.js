...
var jsBloom = require('@koala-live/js-bloom');
var dayjs = _interopDefault(require('dayjs'));
var calendar = _interopDefault(require('dayjs/plugin/calendar'));
var durationPlugin = _interopDefault(require('dayjs/plugin/duration'));
...
function _matchesObject(profile, trait, value) {
  var flat = flattie.flattie(value);
...
function index(profile, element) {
  ...
  if (isEvent(element)) {
    ...
    var props = Object.entries(flattie.flattie((_element$properties = element.properties) != null ? _element$properties : {}));
  ...
  if (typeof element === 'object') {
    var flat = Object.entries(flattie.flattie(element));
...
function build(data) {
  ...
  var bloom = new jsBloom.JsBloom(data.b);
  var counts = new jsBloom.CountMinSketch(data.c);
  var profile = {
    counts: counts,
    bloom: bloom,
...
Object.keys(jsBloom).forEach(function (k) {
...
exports.build = build;
//# sourceMappingURL=edge-api-client.cjs.development.js.map
